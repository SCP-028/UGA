...
project = "TCGA-LUAD"  # "TCGA-UCEC", "TCGA-LUSC", "TCGA-STAD", "TCGA-READ", "TCGA-GBM"
...
filename = 'ResultCount_MERGING_1_NIC1254A72.hg19_rCRSchrm.fa.realign.mdups.recal.cpg.filtered.sort.CG.6plus2.fixed.bed'
